...
<meta name="description"
	content="If you need to talk to the administration, here is our cantact info.">
	...
	<div id="wrapper">
		...
		<div class="container text-center">
			...
			<p>
				...
				post on our <a
					href="http://www.meetup.com/Break-My-Game-Developers-and-Playtesters-Unite/">Meetup
					page</a> and we will respond as fast as possible. However, if you
				need help with something specific, our contact info is below.
			</p>
			...
			<div class="contactBlock col-md-6">
				...
				<p>
					<b>Event Organizer and Head of Break My Game</b> <br> Email: daniel
					at breakmygamegroup.com
					<!--  <br> Twitter handle: -->
				</p>
			</div>
			...
			<div class="contactBlock col-md-6">
				...
				<p>
					<b>Site Administrator</b> <br> Email: mike at breakmygamegroup.com
					<!--  <br> twitter handle:-->
				</p>
			</div>
		</div>
